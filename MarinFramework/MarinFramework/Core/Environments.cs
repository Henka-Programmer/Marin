using MarinFramework.Collections;
...
namespace MarinFramework
{
    ...
    public class Environments : IEnumerable<Environment>
    {
        ...
        public WeakSet<Environment> Envs { get; set; }
        /// <summary>
        ...
        /// </summary>
        public Collections.Dictionary<Field, List<int>> Protected;
        /// <summary>
        /// recomputations {field: ids}
        /// </summary>
        public Collections.Dictionary<object, List<int>> ToCompute;
        /// <summary>
        /// updates {model: {id: {field: value}}}
        /// </summary>
        public Collections.Dictionary<object, Collections.Dictionary<int, Collections.Dictionary<Field, object>>> ToWrite;

        public Environments()
        {
            Envs = new WeakSet<Environment>();
            Cache = new Cache();
            Protected = new Collections.Dictionary<Field, List<int>>();
            ToCompute = new Collections.Dictionary<object, List<int>>();
            ToWrite = new Collections.Dictionary<object, Collections.Dictionary<int, Collections.Dictionary<Field, object>>>();
        }
        ...
        public IEnumerator<MarinFramework.Environment> GetEnumerator()
        {
